...
<section class="contact-form section">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8 text-center">
        <div class="section-title">
          ...
          <h2>Formulario de Registro de Administradores</h2>
          <p class="mt-3">Registrate para tener tu propia cuenta como rol de administrador.</p>
        </div>
      </div>
    </div>
    ...
    <div class="row justify-content-center pb-5">
      ...
      <form id="contact-form" action="/registroAdmin" method="post">
		    @csrf
